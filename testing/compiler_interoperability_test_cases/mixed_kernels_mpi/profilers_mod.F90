! Fortran module that provides interfaces to profilers.
!
! Currently, only the NVIDIA Tools Extension (NVTX) library is provided.

module profilers_mod
